import sys
import os
sys.path.append(os.path.abspath("../datasets/long-range-arena/"))

import lra_benchmarks.image.input_pipeline as input_pipeline
import numpy as np
import pickle

train_ds, eval_ds, test_ds, num_classes, vocab_size, input_shape = input_pipeline.get_cifar10_datasets(
    n_devices = 1, batch_size = 8, normalize = False)
