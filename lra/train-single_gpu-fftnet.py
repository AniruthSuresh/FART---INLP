...
def main():
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,  # Enable shuffling since we're not using a sampler
        num_workers=4,
        pin_memory=True,
    ...
    # No need for DistributedDataParallel wrapper
    ...
    log_file = open("../lra/results/log.txt", "w")
    ...
    for epoch in range(args.epochs):
        ...
        # Update log file
        log_line = f"{epoch+1},{epoch_train_loss:.4f},{epoch_train_acc:.4f},{epoch_val_loss:.4f},{epoch_val_acc:.4f},{epoch_time:.2f}\n"
        ...
        if epoch_val_acc > best_val_acc:
            ...
            epochs_no_improve = 0
            torch.save(model.state_dict(), "../lra/trained_weights/best_model.pth")
